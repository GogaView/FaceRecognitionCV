...
OpenCV_Detection.xcodeproj/project.pbxproj: OpenCV_Detection.pro  /usr/local/Cellar/qt/4.8.7/mkspecs/macx-xcode/qmake.conf /usr/local/Cellar/qt/4.8.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.7/mkspecs/macx-xcode -o OpenCV_Detection.xcodeproj/project.pbxproj OpenCV_Detection.pro
